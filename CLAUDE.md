# UranusResource - Claude Code Guide

## Site
- URL: https://uranusresource.net
- Repo: https://github.com/corganb/uranusresource
...
- Cloudflare Pages project name: `uranusresource-site`
...
## Uranus quirks
- Spacecraft present in scene: Voyager 2
...
```
wrangler pages deploy public --project-name=uranusresource-site --branch=main
```
